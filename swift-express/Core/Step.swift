...
struct StepRunner {
    ...
    private func runRevert(steps: [Step], combinedOutput: [String: StepResponse]) {
    ...
    private func runStep(step: Step, params: [String: Any]) throws -> StepResponse {
        ...
        for index in 0..<step.dependsOn.count {
            ...
            var prevParams: [String:Any]? = nil
            do {
                prevParams = try step.callParams(params, forStep: prevStep, previousStepsOutput: StepResponse(parents: combinedOutput))
